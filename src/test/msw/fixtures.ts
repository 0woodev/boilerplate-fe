/**
 * Mock 데이터 fixtures — 도메인 모델 예시 데이터.
 * handlers.ts 에서 응답용으로 사용.
 */
import type { PatchNote } from '@/hooks/usePatchNotes'

// 도메인별 fixture 추가
// export const mockUsers = [{ user_id: 'usr_test01', email: 'test@example.com', name: 'Test' }]
...
function seedPatchNotes(): PatchNote[] {
  return [
    {
...
export let patchNotes: PatchNote[] = seedPatchNotes()

export function resetPatchNotes(): void {
  patchNotes = seedPatchNotes()
}
